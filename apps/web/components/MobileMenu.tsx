...
export default function MobileMenu({ user, isOpen: controlledIsOpen, onOpenChange }: MobileMenuProps) {
    ...
    return (
        <div className="mobile-menu-wrapper" ref={menuRef}>
            ...
            <div
                className={`fixed inset-0 z-[100] transition-all duration-300 ${isOpen ? 'visible opacity-100 pointer-events-auto' : 'invisible opacity-0 pointer-events-none'}`}
            >
                {/* Backdrop */}
                <div
                ...
                {/* Menu Panel */}
                <div className={`absolute top-0 bottom-0 w-80 max-w-[85vw] bg-white shadow-2xl transition-transform duration-300 ease-out flex flex-col ltr:right-0 rtl:left-0 ${isOpen
                    ? 'translate-x-0'
